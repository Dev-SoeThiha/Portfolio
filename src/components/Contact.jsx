        ...
        <div className='mt-20 flex flex-col md:flex-row justify-between gap-10 md:gap-2'>
            {contacts.map((contact, i) => (
                <div className='text-start flex-1' key={i}>
                    <div className='w-16 aspect-square rounded-full overflow-hidden bg-white flex justify-center items-center'>
                        <contact.icon className='text-3xl w-full text-gray-800' />
                    </div>
